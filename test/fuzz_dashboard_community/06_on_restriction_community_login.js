...
describe('Fuzz: On login access and login from community.', () => 
{
    // var list_length = 3;
    var list_length = fuzzDict.LOGIN_SQL_INJECTION_DECTECTION_FUZZ.length;

    it.only('Fuzz: Change event settings for restrict access on & default code 123456: PUT /backend/api/v2/events/settings/login', async () => 
    {
