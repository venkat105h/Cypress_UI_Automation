...
describe('Create an Event and Sign-in to community', () => {
    ...
    before(async () => {
        var eventList
        if ((process.env.releaseenv == 'qat' && environment.HOrganiserId == '376745') || (process.env.releaseenv == 'release' && environment.HOrganiserId == '350112') || (process.env.releaseenv == 'swat' && environment.HOrganiserId == '350112')) {
